...
function App() {
  ...
  const handleChangeTask = (e) => {
    if (flag === 1) maxx = browserData[browserData.length - 1].taskId + 1;

    if (isEdit) setIpt({ ...ipt, task: e.target.value, taskId: editId });
    else
      setIpt({
        ...ipt,
        task: e.target.value,
        taskId: localStorage.getItem("sanket") ? maxx : 1,
      });
  };
  ...
  const handleChangeTaskHeading = (e) => {
    ...
    if (isEdit) setIpt({ ...ipt, taskHeading: e.target.value, taskId: editId });
    else
      setIpt({
        ...ipt,
  ...
  const handleChangeAssignee = (e) => {
    ...
    if (isEdit) setIpt({ ...ipt, assignee: e.target.value, taskId: editId });
    else
      setIpt({
        ...ipt,
  ...
  const handleChangeStatus = (e) => {
    ...
    if (isEdit) setIpt({ ...ipt, status: e.target.value, taskId: editId });
    else
      setIpt({
        ...ipt,
  ...
  const handleChangePriority = (e) => {
    ...
    if (isEdit) setIpt({ ...ipt, priority: e.target.value, taskId: editId });
    else
      setIpt({
        ...ipt,
  ...
  const handleChangeDate = (e) => {
    ...
    if (isEdit) setIpt({ ...ipt, dot: e.target.value, taskId: editId });
    else
      setIpt({
        ...ipt,
        dot: e.target.value,
  ...
  const handleTaskDesc = (id) => {
    ...
    setIpt({
      task: taskobj.task,
      taskHeading: taskobj.taskHeading,
  ...
  const handleEdit = (id) => {
    ...
    setIpt({
      task: editObj.task,
      taskHeading: editObj.taskHeading,
      assignee: editObj.assignee,
      ...
      <div className="parentcontainer">
        ...
        <div className="maincontainer">
          ...
          <MyTable
            ...
            handleChangeTaskHeading={handleChangeTaskHeading}
            ...
            setShowAddNewTaskModal={setShowAddNewTaskModal}
          />
